...
export const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-18 md:py-28 bg-accent-blue/2">
            ...
            <div className="flex flex-col max-w-2xl">
              ...
              >
                ...
                <p>
                  ...
                  building stable and clean systems where team members can
                  easily collaborate. I prioritise writing code that not only
                  solves the problem at hand but is also easily maintainable and
                  scalable in the future.
                </p>
                <p>
                  I’m a developer who genuinely enjoys continuous learning and
                  refactoring. Outside of coding, I like playing golf and
                  singing.
                </p>
              </div>
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {philosophyData.map((item, philosophyIndex) => (
            <ScrollReveal
              key={item.title}
              direction="left"
              delay={philosophyIndex * 100}
            >
              <Card
                title={item.title}
